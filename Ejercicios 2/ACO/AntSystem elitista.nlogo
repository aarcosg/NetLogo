...
to actualiza-feromona
  ...
  ;; Elitismo. Añadir adicionalmente en cada iteración una cierta cantidad de feromona
  ;; a cada una de las aristas del mejor recorrido encontrado hasta el momento.
...
## EJERCICIO 4 - ACO ELITISTA

Implementa el algoritmo de hormigas elitista, en el que de forma adicional se incrementa la feromona de la mejor solución encontrada hasta el momento.

Para la resolución de este ejercicio se ha tomado como base la resolución al problema del viajante visto en clase aplicando un ACO Elitista, en concreto, se ha modificado la función actualiza-feromona para que se añadan feromonas adicionales a las aristas del mejor recorrido encontrado hasta el momento.

Se ha añadido además un nuevo slider para controlar el factor que se usa en el cálculo de la cantidad de feromona adicional que hay que depositar en la arista.

##¿QUÉ ES?

Este modelo es una implementación del algoritmo AS (Ant System) Elitista aplicado a la resolución del Problema del Viajante.
