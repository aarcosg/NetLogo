...
Prepara algunos ejemplos de clasificación para ser aplicados con los modelos SOM proporcionados en la asignatura.

## CÓMO FUNCIONA
Para este ejercicio se ha preparado un dataset propio con estadísticas sobre los equipos de fútbol de primera división de la liga española de la temporada 2014 - 2015.

Los atributos seleccionados han sido los siguientes (todos ellos vienen representados por valores enteros):
...
El objetio de aplicar SOM es visualizar la relación que existe entre los equipos.

## ANÁLISIS DE RESULTADOS
Los resultados de aplicar SOM son muy llamativos ya que coinciden con la realidad. FC Barcelona y Real Madrid se agrupan muy juntos y tienen el mismo color (ambos equipos quedaron 1º y 2º respectivamente en la clasificación). En la parte opuesta del mapa se encuentran los equipos que descendieron a segunda división: Eibar, Almería y Córdoba.

Analizando el mapa de errores, vemos como Madrid y Barcelona están prácticamente aislados y luego viene un grupo de 3 formado por Atlético de Madrid, Sevilla y Valencia. El resto de equipos forman otro grupo claramente diferenciado. En la realidad, los presupuestos de los equipos también se podrían clasificar del mismo modo.

Concluyendo, los resultados obtenidos en el mapa SOM se ajustan perfectamente a la realidad actual del fútbol español de primera división.

## FUENTES CONSULTADAS
http://resultados.as.com/resultados/futbol/primera/2014_2015/ranking/equipos/
http://www.laliga.es/estadisticas-historicas/clasificacion
